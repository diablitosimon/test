...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2018 at 04:43 AM
...
('m000000_000000_base', 1527810878),
('m130524_201442_init', 1527810883);
...
INSERT INTO `municipios` (`id`, `nombre_municipio`, `departamento_id`) VALUES
(1, 'Leticia', 1),
(2, 'Puerto Nariño', 1),
(3, 'Abejorral', 2),
(4, 'Abriaquí', 2),
...
CREATE TABLE `visitas` (
  ...
  `valor_neto` decimal(8,2) DEFAULT NULL,
  `valor_visita` decimal(8,2) DEFAULT NULL,
...
INSERT INTO `visitas` (`id`, `fecha`, `vendedor`, `valor_neto`, `valor_visita`, `observaciones`, `cliente_id`) VALUES
(2, '2018-06-01 04:06:06', 'john piedrahita', '100000.00', '50000.00', 'Prueba git-hub', 2);
...
--
ALTER TABLE `clientes`
  ADD CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`id`),
  ADD CONSTRAINT `clientes_ibfk_2` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id`);
...
--
ALTER TABLE `visitas`
  ADD CONSTRAINT `visitas_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`);
COMMIT;
